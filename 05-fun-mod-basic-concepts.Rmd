...
modular_modal("drone-vco-out",instructions_html="<ul>
...
<!-- MODAL HTML BLOCK -->
```{r echo=F, out.width="100%"}
modular_modal("drone-vco-scope-out", instructions_html="<ul>
...
",solution_html="<img src='images/patch-solutions/drone-scope_vco-scope-out.png' style='height: 300px; width: auto'>")
```
...
<!-- MODAL HTML BLOCK -->
```{r echo=F, out.width="100%"}
modular_modal("drone-12key-vco-scope-out", instructions_html="<ul>
...
",solution_html="<img src='images/patch-solutions/key-drone_12key-vco-scope-out.png' style='height: 300px; width: auto'>")
```
...
<!-- MODAL HTML BLOCK -->
```{r echo=F, out.width="100%"}
modular_modal("drone-12key-vco-vca-scope-out", instructions_html="<ul>
...
",solution_html="<img src='images/patch-solutions/key-note_12key-vco-vca-scope-out.png' style='height: 300px; width: auto'>")
```
...
<!-- MODAL HTML BLOCK -->
```{r echo=F, out.width="100%"}
modular_modal("drone-12key-vco-env-vca-scope-out", instructions_html="<ul>
...
",solution_html="<img src='images/patch-solutions/key-envelope_12key-vco-env-vca-scope-out.png' style='height: 300px; width: 718px'>")
```
