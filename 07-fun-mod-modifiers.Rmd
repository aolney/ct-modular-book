...
3. `r mc_question("What is the phase shift at the cuttoff point in a low pass filter?", list(  answer="-45 degrees",
            "-90 degrees",
            "90 degrees",
            "180 degrees"))`

4. `r mc_question("How much is the signal attenuated at the cuttoff point in a low pass filter?", list(  answer="3 dB",
            "6 dB",
            "0 dB",
            "18 dB"))`
