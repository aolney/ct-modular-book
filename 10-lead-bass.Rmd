...
",solution_html="<h4>Solution for two square waves only</h4><img class='rack-image-6u' src='images/patch-solutions/st-square40-square82.png'>")
```
...
```{r stranger-things_two-squares-and-saw-square-mixed-to-match-sample7, echo=F, out.width="100%", fig.cap="(ref:stranger-things_two-squares-and-saw-square-mixed-to-match-sample7)"}
 knitr::include_graphics("images/stranger-things_two-squares-and-saw-square-mixed-to-match-sample7.png")
```
