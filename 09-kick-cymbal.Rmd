...
```{r, kick2, out.width='100%', fig.cap="(ref:kick2)", dev='png', cache=FALSE, screenshot.opts=list(vwidth=400,cliprect = c(0, 0, 400, 60)), echo=F}
...
```{r, osc-banks-envelope-noise-kick-freq-decay, out.width='100%', fig.cap="(ref:osc-banks-envelope-noise-kick-freq-decay)", dev='png', cache=FALSE, screenshot.opts=list(vwidth=400,cliprect = c(0, 0, 400, 300)), echo=F}
