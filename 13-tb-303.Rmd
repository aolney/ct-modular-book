...
(ref:tb303-seq-extendgate) [Virtual modular](https://cardinal.olney.ai) for extending the 303 patch with extended gates.
...
",solution_html="<img class='rack-image' src='images/patch-solutions/tb303-seq-extendgate.png'>")
```
...
The song may sound more correct now but flawed in a different way.
This is because the last patch replaced all gates with extended gates.
Since a few gates are regular gates, they are currently not being generated.
...
We'll throw in some logic to show that the logic doesn't actually matter.
...
",solution_html="<img class='rack-image' src='images/patch-solutions/tb303-seq-extendgate-reggate.png'>")
```
...
",solution_html="<img class='rack-image' src='images/patch-solutions/tb303-seq-extendgate-reggate-slidegate.png'>")
```
...
The waveshapes produced by the 303 are a bit unusual, as shown in Figure \@ref(fig:tb303-square-saw).
The 303's square wave has a sloping top.
According to Whittle, the duty cycle of the square wave at high pitches is about 45% but about 71% at the lowest pitches. 


(ref:tb303-square-saw) Square (left) and saw (right) waves for a C note from the Din Sync reference recordings. Note neither waveshape matches the canonical form.

```{r tb303-square-saw, echo=F, out.width="100%", fig.cap="(ref:tb303-square-saw)"}
 knitr::include_graphics("images/tb303-square-saw.jpg")
```

(ref:tb303-square-saw-hpf) TODO

```{r tb303-square-saw-hpf, echo=F, out.width="100%", fig.cap="(ref:tb303-square-saw-hpf)"}
 knitr::include_graphics("images/tb303-square-saw-hpf-out.png")
```
...
",solution_html="<img class='rack-image' src='images/patch-solutions/tb303-seq-extendgate-reggate-slidegate-osc.png'>")
```
...
",solution_html="<img class='rack-image' src='images/patch-solutions/tb303-seq-extendgate-reggate-slidegate-osc-megveg.png'>")
```
...
",solution_html="<img class='rack-image' src='images/patch-solutions/tb303-seq-extendgate-reggate-slidegate-osc-megveg-accents.png'>")
```
...
",solution_html="<img class='rack-image' src='images/patch-solutions/tb303-final.png'>")
```
