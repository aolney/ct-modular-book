...
modular_modal("pitch-seq-303", starter_file="empty.vcv", instructions_html="<ul>
...
",solution_html="<h4>Solution for two square waves only</h4><img class='rack-image' src='images/patch-solutions/pitch-seq-303.png'>")
```

<!-- CAPTION BLOCK -->
```{r pitch-seq-303, echo=F, out.width="100%", fig.cap="(ref:pitch-seq-303)"}
modular_caption()
```
