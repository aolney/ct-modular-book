...
<li>Slowly turn up the carrier FM knob. This will increase the modulation index. Observe the changes in both the spectrum and the pitch of the sound. At what modulation index doe the pitch seem to noticably change? Does the sound become inharmonic at a different time or the same time?</li>
...
<!-- TODO EFM percussion; mention  sound design chapter except we can use just the attenuator on the FM input instead of going into the V/oct through a VCA
 -->
