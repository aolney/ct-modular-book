...
<!-- MODAL HTML BLOCK -->
```{r echo=F, out.width="100%"}
modular_modal("tzfm-keyboard-frequency-tracking", starter_file="lfm-keyboard-frequency-tracking.vcv", instructions_html="<ul>
<li>Disconnect the LFO for now</li>
...
",solution_html="<img class='rack-image-6u' src='images/patch-solutions/tzfm-keyboard-frequency-tracking.png'>")
```

<!-- CAPTION BLOCK -->
```{r tzfm-keyboard-frequency-tracking, echo=F, out.width="100%", fig.cap="(ref:tzfm-keyboard-frequency-tracking)"}
modular_caption()
```
...
```{r wheel-sine-2, echo=F, out.width="80%", fig.cap="(ref:wheel-sine-2)"}
...
<!-- MODAL HTML BLOCK -->
```{r echo=F, out.width="100%"}
modular_modal("pm-keyboard-frequency-tracking", starter_file="tzfm-keyboard-frequency-tracking.vcv", instructions_html="<ul>
<li>Disconnect the LFO for now</li>
...
",solution_html="<img class='rack-image-6u' src='images/patch-solutions/pm-keyboard-frequency-tracking.png'>")
```

<!-- CAPTION BLOCK -->
```{r pm-keyboard-frequency-tracking, echo=F, out.width="100%", fig.cap="(ref:pm-keyboard-frequency-tracking)"}
modular_caption()
```
...
1. `r mc_question("When a signal's amplitude is modulated, the result is:", list(  answer="amplitude modulation",
            "frequency modulation",
            "phase modulation"))`
            
2. `r mc_question("When a signal's phase is modulated, the result is:", list(              "amplitude modulation",
            "frequency modulation",
            "frequency hopping",
            answer="phase modulation"))`
            
3. `r mc_question("What type of frequency modulation moves the output signal an equal musical interval around the carrier's default value?", list(              "PM",
            "linear FM",
            "through-zero linear FM",
            answer="exponential FM"))`
            
4. `r mc_question("What causes pitch shift in frequency modulation?", list(              "digital modulation",
            "analogue modulation",
            "symmetric modulation",
            answer="asymmetric modulation"))`
            
5. `r mc_question("Which of the following does not behave like true FM?", list(                          "through-zero FM",
            "PM",
            answer="linear FM"))`
<!-- **template** -->
