...
The following chapters will go into the three module categories (controllers, generators, and modifiers) in more detail but similarly provide concrete examples along the way.
