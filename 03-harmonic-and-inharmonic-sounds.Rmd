...
# knitr::include_url("images/drum-modes.html", height = "140px")
# second pass, use deployed url so pdf will also build
knitr::include_url("https://olney.ai/ct-modular-book/images/drum-modes.html", height = "140px")
```
...
```{r, noise-types, out.width='100%', fig.cap="(ref:noise-types)", dev='png', cache=TRUE, screenshot.opts=list(vwidth=400,cliprect = c(0, 0, 400, 300)), echo=F}
# first pass, use local file, build html, and deploy html
# knitr::include_url("images/noise-table.html", height = "510px")
# second pass, use deployed url so pdf will also build
knitr::include_url("https://olney.ai/ct-modular-book/images/noise-table.html", height = "510px")
```
...
```{r adsr-envelope, echo=F, out.width="100%", fig.cap="(ref:adsr-envelope)"}
 knitr::include_graphics("images/adsr-envelope.PNG")
```
...
<!-- NOTE: must manually copy constituent images to docs/images -->
```{r, adsr-sound-table, out.width='100%', fig.cap="(ref:adsr-sound-table)", dev='png', cache=TRUE, screenshot.opts=list(vwidth=400,cliprect = c(0, 0, 400, 300)), echo=F}
# first pass, use local file, build html, and deploy html
# knitr::include_url("images/adsr-sound-table.html", height = "150px")
# second pass, use deployed url so pdf will also build
knitr::include_url("https://olney.ai/ct-modular-book/images/adsr-sound-table.html", height = "150px")
```

## Check your understanding

1. `r mc_question("How many waves are needed to form a standing wave?", list(  answer="2",
            "1",
            "4",
            "3"))`
            
2. `r mc_question("The key ingredient for standing waves is:", list(  answer="constructive interference",
            "destructive interference",
            "matched frequency",
            "matched amplitude"))`

3. `r mc_question("What relationship do harmonics have to the fundamental frequency?", list(  answer="harmonics are integer multiples of the fundamental frequency",
...
4. `r mc_question("What are the relative strengths of frequencies emitted by a resonator called?", list(  answer="formants",
            "nodes",
            "Q",
            "frequency spectrum"))`
            
5. `r mc_question("What is the only basic waveshape that has both even and odd harmonics?", list(  answer="saw",
            "square",
            "sine",
            "triangle"))`  
            
6. `r mc_question("Compared to string instruments, percussion instruments have partials that are:", list(  answer="inharmonic and dense",
            "inharmonic and sparse",
            "harmonic and dense",
            "harmonic and sparse"))`  
            
7. `r mc_question("What ADSR stage's length is not determined by time?", list(  answer="sustain",
            "attack",
            "release",
            "decay"))`  
<!-- Tonal sounds	 -->
