...
(ref:saw-phase) Interference from a perfectly out of phase saw wave (yellow) combined with the original wave (blue). The resulting wave (green) has non-zero amplitude because the out of phase wave does not have opposite amplitude to the original wave at all locations. Dotted lines indicate the positions of the original waves.

```{r saw-phase, echo=F, out.width="100%", fig.cap="(ref:saw-phase)"}
 knitr::include_graphics("images/saw-phase.gif")
```
