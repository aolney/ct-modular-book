...
```{r firecracker-wave, echo=F, out.width="100%", fig.cap="(ref:firecracker-wave)"}
 knitr::include_graphics("http://media.npr.org/assets/img/2014/01/21/cracker.gif")
```
...
```{r schlieren-wave, echo=F, out.width="100%", fig.cap="(ref:schlieren-wave)"}
 knitr::include_graphics("http://media.npr.org/assets/img/2014/01/21/speaker1.gif")
```
...
knitr::include_url("https://phet.colorado.edu/sims/html/waves-intro/latest/waves-intro_en.html")
```
