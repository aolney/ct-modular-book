...
```{r saw-phase, echo=F, out.width="100%", fig.cap="(ref:saw-phase)"}
  embed_linked_media("images/saw-phase.gif")
```
...
1. `r mc_question("The frequency of the note A one octave above a given A is:", list(  answer="double the frequency",
            "half the frequency",
            "the square root of the frequency",
            "the frequency squared"))`
            
2. `r mc_question("What is the standard unit of frequency?", list(  answer="Hertz",
            "octaves",
            "semitones",
            "microtones"))`
            
3. `r mc_question("What is the only guaranteed way to achieve phase cancellation?", list(  answer="adding an inverted wave",
            "adding a perfectly out of phase wave",
            "subtracting an inverted wave",
            "subtracting a perfectly out of phase wave"))`
            
4. `r mc_question("In Western music, the octave is divided into how many semitones?", list(  answer="12",
            "8",
            "4",
            "16"))`

5. `r mc_question("The perceptual correlate of frequency is:", list(  answer="pitch",
            "loudness",
            "timbre"
            ))`
            
6. `r mc_question("The perceptual correlate of amplitude is:", list(  answer="loudness",
            "pitch",
            "timbre"
            ))`
            
7. `r mc_question("A doubling of amplitude is an increase of how many dB?", list(  answer="6",
            "10",
            "20",
            "3"
            ))`
